...
@pytest.fixture(scope="module")
def has_rewards():
    has_rewards = False  # MIM True, FRAX False, do false for mim though because no rewards now and voter holds MIM
    yield has_rewards


# this is whether our strategy is convex or not. false means it's curve.
@pytest.fixture(scope="module")
def is_convex():
    is_convex = False
    yield is_convex
