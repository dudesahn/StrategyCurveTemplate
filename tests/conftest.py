...
@pytest.fixture(scope="session")
def amount():
    amount = 165e18  # 165 for EURS-USDC, 330k for EURS, 472 for 3EUR
    yield amount
...
def whale(accounts, amount, token):
    ...
    whale = accounts.at("0xcF269308b782e9FF73634bA7DEd40A6C987831E9", force=True)
...
@pytest.fixture(scope="session")
def strategy_name():
    strategy_name = "StrategyCurveEURS-USDC"
    yield strategy_name
